  ...
  <Box>
    <Container>
      ...
      <SimpleGrid columns={{ sm: 1, md: 2 }} spacing={10}>
        ...
        <Box>
          <Heading as="h3" color="gray.600" fontSize={28} mb={2}>
            Get Paid Quickly, Work Efficiently
          </Heading>
          <p>
            Getting paid should never slow you down. LittleBot Invoices uses
            bionic powers to seamlessly integrate onto your WordPress site so
            you can request and estimate payments without ever leaving your
            website. Create clear and accurate invoices at breakneck speed.
            Because robots are the new unicorns.
          </p>
